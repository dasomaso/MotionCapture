...
%MyData = config;
%config.files.points = 'F:/workspace/Qt/Mocap/matlab/CalibrationDat/points.dat';
%config.files.IdMat = 'F:/workspace/Qt/Mocap/matlab/CalibrationDat/IdMat.dat';
%config.files.Res = 'F:/workspace/Qt/Mocap/matlab/CalibrationDat/Res.dat';
